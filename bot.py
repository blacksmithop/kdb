...
initial_extensions: List[str] = ["cogs.help","cogs.wiki","cogs.OKP", "cogs.movies", "cogs.globaltrans", "cogs.admin", "cogs.ascii","cogs.chatter", "cogs.fox", "cogs.ranker","cogs.urban", "cogs.memegen"]
